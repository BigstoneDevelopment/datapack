# Helmet
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s inventory.* minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run clear @s minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"]
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s player.crafting.0 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s player.crafting.0 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s player.crafting.1 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s player.crafting.1 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s player.crafting.2 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s player.crafting.2 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s player.crafting.3 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s player.crafting.3 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s weapon.offhand minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s weapon.offhand with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s player.cursor minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s player.cursor with air
execute if score @s bigstone_sandbox_enabled matches 1 run kill @e[name="helmet_bigstone_sandbox"]
...
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s player.crafting.0 minecraft:player_head[item_name="previous_page_bigstone_sandbox"] run item replace entity @s player.crafting.0 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s player.crafting.1 minecraft:player_head[item_name="previous_page_bigstone_sandbox"] run item replace entity @s player.crafting.1 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s player.crafting.2 minecraft:player_head[item_name="previous_page_bigstone_sandbox"] run item replace entity @s player.crafting.2 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s player.crafting.3 minecraft:player_head[item_name="previous_page_bigstone_sandbox"] run item replace entity @s player.crafting.3 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s weapon.offhand minecraft:player_head[item_name="previous_page_bigstone_sandbox"] run item replace entity @s weapon.offhand with air
...
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s player.crafting.0 minecraft:player_head[item_name="next_page_bigstone_sandbox"] run item replace entity @s player.crafting.0 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s player.crafting.1 minecraft:player_head[item_name="next_page_bigstone_sandbox"] run item replace entity @s player.crafting.1 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s player.crafting.2 minecraft:player_head[item_name="next_page_bigstone_sandbox"] run item replace entity @s player.crafting.2 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s player.crafting.3 minecraft:player_head[item_name="next_page_bigstone_sandbox"] run item replace entity @s player.crafting.3 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s weapon.offhand minecraft:player_head[item_name="next_page_bigstone_sandbox"] run item replace entity @s weapon.offhand with air
...
# Next Button
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s inventory.* minecraft:barrier[item_name="exit_bigstone_sandbox"] run clear @s minecraft:player_head[item_name="exit_bigstone_sandbox"]
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s player.crafting.0 minecraft:barrier[item_name="exit_bigstone_sandbox"] run item replace entity @s player.crafting.0 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s player.crafting.1 minecraft:barrier[item_name="exit_bigstone_sandbox"] run item replace entity @s player.crafting.1 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s player.crafting.2 minecraft:barrier[item_name="exit_bigstone_sandbox"] run item replace entity @s player.crafting.2 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s player.crafting.3 minecraft:barrier[item_name="exit_bigstone_sandbox"] run item replace entity @s player.crafting.3 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s weapon.offhand minecraft:barrier[item_name="exit_bigstone_sandbox"] run item replace entity @s weapon.offhand with air
...
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s player.crafting.0 minecraft:player_head[item_name="component_bigstone_sandbox"] run item replace entity @s player.crafting.0 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s player.crafting.1 minecraft:player_head[item_name="component_bigstone_sandbox"] run item replace entity @s player.crafting.1 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s player.crafting.2 minecraft:player_head[item_name="component_bigstone_sandbox"] run item replace entity @s player.crafting.2 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s player.crafting.3 minecraft:player_head[item_name="component_bigstone_sandbox"] run item replace entity @s player.crafting.3 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s weapon.offhand minecraft:player_head[item_name="component_bigstone_sandbox"] run item replace entity @s weapon.offhand with air
...
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.0 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.0 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.1 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.1 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.2 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.2 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.3 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.3 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.4 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.4 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.5 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.5 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.6 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.6 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.7 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.7 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.8 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.8 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.9 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.9 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.10 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.10 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.11 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.11 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.12 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.12 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.13 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.13 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.14 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.14 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.15 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.15 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.16 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.16 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.17 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.17 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.18 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.18 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.19 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.19 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.20 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.20 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.21 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.21 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.22 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.22 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.23 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.23 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.24 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.24 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.25 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.25 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.26 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.26 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.27 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.27 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.28 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.28 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.29 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.29 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.30 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.30 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.31 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.31 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.32 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.32 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.33 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.33 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.34 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.34 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.35 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.35 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.36 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.36 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.37 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.37 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.38 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.38 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.39 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.39 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.40 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.40 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.41 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.41 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.42 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.42 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.43 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.43 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.44 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.44 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.45 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.45 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.46 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.46 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.47 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.47 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.48 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.48 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.49 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.49 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.50 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.50 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.51 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.51 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.52 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.52 with air
execute if score @s bigstone_sandbox_enabled matches 1 if items entity @s container.53 minecraft:orange_stained_glass[item_name="helmet_bigstone_sandbox"] run item replace entity @s container.53 with air
