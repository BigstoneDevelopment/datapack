...
execute if score @s bs_auto_exit_on_join_VAL matches -1 run tellraw @s [{text:"    [x]  ",bold:true,color:"red",click_event:{action:"run_command",command:"trigger bs_auto_exit_on_join"}},{text:"Auto exit Sandbox on join",color:"gray",bold:false},{text:"\n"}]
execute if score @s bs_auto_exit_on_join_VAL matches 1 run tellraw @s [{text:"    [✔]  ",bold:true,color:"green",click_event:{action:"run_command",command:"trigger bs_auto_exit_on_join"}},{text:"Auto exit Sandbox on join",color:"gray",bold:false},{text:"\n"}]
...
execute if score @s bs_change_page_on_hold_VAL matches -1 run tellraw @s [{text:"    [x]  ",bold:true,color:"red",click_event:{action:"run_command",command:"trigger bs_change_page_on_hold"}},{text:"Hold to switch component page",color:"gray",bold:false},{text:"\n"}]
execute if score @s bs_change_page_on_hold_VAL matches 1 run tellraw @s [{text:"    [✔]  ",bold:true,color:"green",click_event:{action:"run_command",command:"trigger bs_change_page_on_hold"}},{text:"Hold to switch component page",color:"gray",bold:false},{text:"\n"}]
